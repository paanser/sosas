...
if opcion_precio == "Ingresar manualmente":
    ...
    with st.expander("Ver tabla de referencia (chuleta)"):
        st.markdown("**Ejemplos de precios comunes:**")
        st.markdown("- Clear 4mm: $210")
        st.markdown("- Clear 6mm: $260")
        st.markdown("- Extra Claro 6mm: $330")
        st.markdown("- Laminado 3+3: $450")
        st.markdown("- Templado 10mm: $610")
